...
@section('content_header')
    <h1 style="text-align: center">Porcesos Creados</h1>
                                    ...
                                    <table class="table table-bordered table-striped" id="provedor">
                                        <thead class="table-secondary">
                                            <tr style="text-align: center">
                                                <th scope="col">Pro Prefijo</th>
                                                <th scope="col">Pro Nombre</th>
                                                <th scope="col">Acciones</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($Pro_Proceso as $info)
                                                <tr style="text-align: center">
                                                    <td>{{$info->pro_prefijo}}</td>
                                                    <td>{{$info->pro_nombre}}</td>
                                                        ...
                                                        <div class="dropdown">
                                                            <a class="btn btn-sm btn-icon-only text-dark" style="font-size: 20px" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                                    ...
                                                                    <a href="{{route('edit.Pro_Proceso', $info->id)}}" class="btn btn-outline-warning"><i class="material-icons">edit</i></a>

                                                                    <form action="{{route('destroy.Pro_Proceso', $info->id)}}" class="form-eliminar" method="POST" style="display:inline-block">
                                                                        @csrf
                                                                        @method('DELETE')
