...
@section('content_header')
    <h1 style="text-align: center">Editar Documento</h1>
@stop
            ...
            <div class="col-md-12">
                <div class="card card-user">
                    <div class="card-body">
                        ...
                        <form action="{{route('edit.Doc_Documento',$doc_Documento)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4 box">
                                        <input type="text" name="doc_nombre" value="{{old('doc_nombre',$doc_Documento->doc_nombre)}}" required="required">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4 box">
                                        <input type="number" name="doc_codigo" value="{{old('doc_codigo',$doc_Documento->doc_codigo)}}" required="required">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <div class="mb-4 box">
                                            ...
                                            <select name="doc_id_tipo" class="form-control">
                                                ...
                                                <option value="">{{$tip['tip_nombre']}}</option>
                            ...
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="mb-4 box">
                                    ...
                                    <select name="doc_id_proceso" id="" class="form-control">
                                        ...
                                        <option value="">{{$proceso['pro_prefijo']}}</option>
                                            
                                        @if($proceso != $proceso)

                                            <option value="{{ $proceso['id']}}">{{$proceso['pro_prefijo']}}</option>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="mb-4 box">
                                    ...
                                    <textarea name="doc_contenido" cols="136" rows="5" required="required">{{old('doc_contenido',$doc_Documento->doc_contenido)}}</textarea>
